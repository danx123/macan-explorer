...
class ConfigManager:
    ...
    def _load_config(self):
        ...
        if os.path.exists(self.config_path):
            ...
            self.config_data = {"added_folders": []}
            self._save_config()
...
class FileView(QWidget):
    ...
    def refresh(self):
        if hasattr(self.model, 'icon_cache'):
            self.model.icon_cache.clear()
