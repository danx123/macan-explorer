...
class SearchResultsDialog(QDialog):
    ...
    def _on_item_double_clicked(self, item):
        ...
        if os.path.isdir(full_path):
            ...
            self.result_selected.emit(directory)
        self.accept()
